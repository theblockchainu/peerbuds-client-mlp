...
export class InviteFriendsDialogComponent implements OnInit {
  ...
  public onEmailClicked() {
    window.location.href = 'mailto:' + this.loggedinUserEmail + '?Subject=Want to join me for this workshop?&body=Hey, I found this really fitting workshop you should look at - http://localhost:8080/' + this.url;
  }
