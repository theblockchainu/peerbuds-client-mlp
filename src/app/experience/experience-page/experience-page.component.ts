...
export class ExperiencePageComponent implements OnInit {
  ...
  public editCalendar() {
    ...
    this.dialogsService
      .editCalendar({ id: this.experienceId, type: this.experience.type, name: this.experience.title }, this.experience.contents, this.experience.calendars, this.allItenaries, this.allParticipants, this.events, this.userId, sortedCalendar[sortedCalendar.length - 1].startDate, sortedCalendar[sortedCalendar.length - 1].endDate)
      .subscribe(res => {
        if (res) {
          this.result = res;
