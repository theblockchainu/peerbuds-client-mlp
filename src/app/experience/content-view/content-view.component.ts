  ...
  public showItineraryDate(date) {
    ...
    public findAndOpenDialog(index) {
      ...
      // else {
        ...
        switch (contentType) {
            case 'online':
                dialogRef = this.dialog.open(ExperienceContentOnlineComponent, {data: {itenaryForm: this.itenaryForm, index: index, isEdit: isEdit}, disableClose: true, hasBackdrop: true, width: '45vw', height: '90vh'});
                break;
            case 'project':
                dialogRef = this.dialog.open(ExperienceContentProjectComponent, {data: {itenaryForm: this.itenaryForm, index: index, isEdit: isEdit, collectionStartDate: this.collectionStartDate, collectionEndDate: this.collectionEndDate}, disableClose: true, hasBackdrop: true, width: '45vw', height: '90vh'});
                break;
            case 'video':
                dialogRef = this.dialog.open(ExperienceContentVideoComponent, {data: {itenaryForm: this.itenaryForm, index: index, isEdit: isEdit}, disableClose: true, hasBackdrop: true, width: '45vw', height: '90vh'});
                break;
            default:
                break;
        }
